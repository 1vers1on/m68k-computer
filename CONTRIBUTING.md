...
The [revision 1.1 memory map](docs/static/memory-map.html) is frozen. An address-range, I/O-slot, or register-address change needs a new memory-map revision and coordinated updates to the affected hardware, firmware, software, and documentation.
